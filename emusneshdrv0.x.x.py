...
class EmuSNESApp:
    def __init__(self, master):
        ...
        # --- Startup splash ---
        self.screen.create_text(256, 180, text="EmuSNES v0.1", fill="white", font=("Arial", 24,"bold"), tags="startup")
        self.screen.create_text(256, 220, text="Super Nintendo Entertainment System Emulator",
                                fill="#808080", font=("Arial", 10), tags="startup")
        self.screen.create_text(256, 260, text="© 2025 Flames Co. Labs", fill="#606060", font=("Arial", 8), tags="startup")
        self.screen.create_text(256, 275, text="A Samsoft Interactive Production",
                                fill="#606060", font=("Arial", 8), tags="startup")
        ...
        self.screen.create_text(256, 330, text="File > Open ROM… to begin",
                                fill="white", font=("Arial", 11), tags="startup")
